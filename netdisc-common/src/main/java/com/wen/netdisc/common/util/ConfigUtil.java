...
public class ConfigUtil {
    ...
    public static int trashKeepDay;


    @Value("${x-netdisc.trash.keep-day}")
    public void setTrashKeepDay(int trashKeepDay) {
        ConfigUtil.trashKeepDay = trashKeepDay;
    }

    @Value("${x-netdisc.user.super-admin.userName}")
    public void setAdminName(String superAdminName) {
        ConfigUtil.superAdminName = superAdminName;
    }

    @Value("${x-netdisc.user.super-admin.login-name}")
    public void setSuperAdminLoginName(String superAdminLoginName) {
        ConfigUtil.superAdminLoginName = superAdminLoginName;
    }


    @Value("${x-netdisc.user.super-admin.password}")
    ...
    public static int getTrashKeepDay() {
        return trashKeepDay;
    }
}
*/
