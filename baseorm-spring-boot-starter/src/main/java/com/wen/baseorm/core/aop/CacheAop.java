package com.wen.baseorm.core.aop;

import com.mysql.cj.log.Log;
import com.wen.baseorm.config.PropertyConfig;
import com.wen.baseorm.core.annotation.CacheUpdate;
...
public class CacheAop {
    ...
    @Pointcut("@annotation(com.wen.baseorm.core.annotation.CacheQuery)")
    public void queryPointcut() {

    }

    @Pointcut("@annotation(com.wen.baseorm.core.annotation.CacheUpdate)")
